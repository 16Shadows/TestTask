...
namespace TestTaskBackend.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordFor = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordEntries_PasswordType_PasswordFor",
                table: "PasswordEntries",
                columns: new[] { "PasswordType", "PasswordFor" },
                unique: true);
        }
